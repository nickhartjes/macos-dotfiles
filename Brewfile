...
# ─── Bootstrap (required for dotfiles setup) ───────────
...
# ─── Dev Tools ───────────────────────────────────────────
brew "bun"            # Fast JavaScript runtime and toolkit
...
brew "llmfit"         # Find what LLM models run on your hardware
cask "lmstudio"       # Local LLM runner
brew "opencode"       # AI coding agent TUI
